      ...
      {showLoginDialog && (
        <div className="absolute top-14 right-0 m-4 p-8 pt-10 rounded-md bg-amber-50/90 backdrop-blur-sm">
          <button
            ...
            className="absolute top-2 right-2 rounded-full border border-cyan-700 p-1 bg-amber-100 hover:bg-cyan-700 hover:text-amber-50"
          >
            <XMarkIcon className="w-5 h-5 hover:text-amber-50" />
          </button>
